...
| File | Description |
|---|---|
| [`Data_Analysis_Source_File.Rmd`](./Data_Analysis_Source.Rmd) | The executable R Markdown source file containing the R code, analytical steps, comments, tables, and figures used in the study. |
| [`Data_Analysis_Output_With_R_Scripts.html`](./Data_Analysis_Output_With_R_Scripts.html) | The knitted HTML output generated from the R Markdown file. It provides a viewable record of the code, outputs, tables, figures, model results, and diagnostics produced during the analysis. |
...
> Wangchuk, T. (2026). *Data analysis pipeline for Conceptualising Technology Threat Avoidance Theory (TTAT) to Examine Cognitive Risks of Generative AI in Higher Education* [R Markdown and HTML files]. GitHub. https://github.com/twt808/MIS_Thesis_Data_Analysis/
